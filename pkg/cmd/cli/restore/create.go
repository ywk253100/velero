...
func (o *CreateOptions) BindFlags(flags *pflag.FlagSet) {
	...
	flags.StringVar(&o.ExistingVolumeDataPolicy, "existing-volume-data-policy", "", "Restore Policy to be used during the restore workflow for volume data, can be - none, overwrite or incremental")
	...
	f = flags.VarPF(&o.DeleteExtraFiles, "delete-extra-files", "", "Whether to delete extra files in the target volume that do not exist in the backup during file system restore.")
	f.NoOptDefVal = cmd.TRUE
}
...
func (o *CreateOptions) Validate(c *cobra.Command, args []string, f client.Factory) error {
	...
	if len(o.ExistingVolumeDataPolicy) > 0 && !restore.IsVolumeDataPolicyValid(o.ExistingVolumeDataPolicy) {
		return errors.New("existing-volume-data-policy has invalid value, it accepts only none, overwrite, incremental as value")
	}
