...
func (r *RestoreSpec) IsVolumeDataInplaceRestore() bool {
	return r.ExistingVolumeDataPolicy == VolumeDataPolicyTypeOverwrite || r.ExistingVolumeDataPolicy == VolumeDataPolicyTypeIncremental
}
...
const (
	...
	// VolumeDataPolicyTypeOverwrite means velero will try to overwrite on the volume data if the volume already exists.
	VolumeDataPolicyTypeOverwrite VolumeDataPolicyType = "overwrite"
