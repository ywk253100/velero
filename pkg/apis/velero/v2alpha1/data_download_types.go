...
type DataDownloadStatus struct {
	...
	// IncrementalBytes holds the number of bytes new or changed since the last snapshot
	// +optional
...
// +kubebuilder:printcolumn:name="Restore Type",type="string",JSONPath=".spec.restoreType",description="Restore type such as Full/Incremental"
...
// +kubebuilder:printcolumn:name="Incremental Bytes",type="integer",format="int64",JSONPath=".status.incrementalBytes",description="Incremental bytes"
