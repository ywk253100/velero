...
func (e *genericRestoreExposer) CleanUp(ctx context.Context, ownerObject corev1api.ObjectReference, param *GenericRestoreCleanUpParam) {
	...
	if param.DataDownload != nil && param.DataDownload.Spec.CSISnapshot != nil {
		kube.EnsureDeleteVolumeSnapshotIfAny(ctx, e.ctrlClient, param.DataDownload.Spec.CSISnapshot.VolumeSnapshotNamespace,
			param.DataDownload.Spec.CSISnapshot.VolumeSnapshot, 0, e.log)
	}
}
